...
export function AuthForm({ mode = 'signin', callbackUrl = '/' }: AuthFormProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-gold-50 px-4 py-8">
      <div className="w-full max-w-md transform transition-all duration-600 ease-in-out">
        <Card className="shadow-card border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-8">
            <div className="mx-auto flex items-center gap-3 mb-4 transform transition-all duration-600 ease-in-out">
              <Image
              ...
              <div className="text-left">
                <h1 className="text-xl font-bold text-brand">Noor AlTayseer</h1>
